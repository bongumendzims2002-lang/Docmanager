...
public class DocumentManager {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    createDocument(fileName, scanner);
                    break;
                case 2:
                    editDocument(fileName, scanner);
                    break;
                case 3:
    ...
    public static void createDocument(String fileName, Scanner scanner) {
        try {
            FileWriter writer = new FileWriter(fileName);
            System.out.print("Enter text for the document: ");
